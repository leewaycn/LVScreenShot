...
#import "WKWebViewShotVC.h"

#import "WKWebView+LVShot.h"
@interface WKWebViewShotVC ()<WKUIDelegate,WKNavigationDelegate>
    {
        CGFloat height;
        CGFloat width;
        WKWebView *webView;
...
@implementation WKWebViewShotVC
...
- (void)viewDidLoad {
    ...
    webView = [[WKWebView alloc]initWithFrame:CGRectMake(10, 100, width, height-150)];
